...
@section("content")
    ...
    <div class="inner-container container" style="margin-top: 50px;
      ...
      <div class="top-section clearfix">
              ...
              <a href="{{route('blog.single',['id'=> $result->id]) }}">   <img src="{{URL::asset($result->feature)}}" class="lazyOwl" alt="{{$result->title}}" style="max-width: 100%; height: auto; border-top-left-radius: 80px 80px;"> 
</a>  
            </div>
                <!-- Description-->
                <div class="col-xs-12 col-md-6 col-sm-12"">
