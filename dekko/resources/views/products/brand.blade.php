...
<div class="inner-container container" style="margin-top: 50px; margin-bottom: 50px;">
    <div class="top-section clearfix">
        ...
        <div class="col-xs-12 col-md-6 col-sm-12">
            <h1 style="font-size: clamp(32px,calc(32px + ((1vw - 3.75px) * 1.8122977346)),60px); color: #e1141e; text-transform: uppercase; font-family: TankerComplete; font-weight: inherit; ">{{$brand->name}}</h1>
            <p class="details">{!! $brand->description !!}</p>
