...
@endforeach            
    ...
    <li class="parent-menu">
      ...
      <ul class="submenu">
        <li><a href="https://chaldal.com/dekko" class="{{classActivePathPublic('Chaldal')}}">{{ 'Chaldal' }}</a></li>
        <li><a href="https://www.daraz.com.bd/shop/dekko/" class="{{ classActivePathPublic('Daraz') }}">{{ 'Daraz' }}</a></li>
      </ul>
    </li>
  </ul>
</nav>
