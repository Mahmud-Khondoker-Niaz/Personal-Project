        ...
        <table class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            ...
            <?php $__currentLoopData = $allusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            	...
            	<td> <?php if($users->image_icon): ?>
								...
								<?php endif; ?></td>
                <td><a href="<?php echo e(URL::to('user/details',$users->id)); ?>" class=""><?php echo e($users->name); ?></a></td>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dekko\resources\views/admin/pages/users.blade.php ENDPATH**/ ?>