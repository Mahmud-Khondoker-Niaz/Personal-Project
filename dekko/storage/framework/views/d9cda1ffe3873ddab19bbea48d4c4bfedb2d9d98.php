				...
				<li>
					<a href="#" class="user" id="showUserPush">
						 ...
						 <?php if(Auth::user()->user_icon): ?>
									...
									<img src="<?php echo e(URL::asset('upload/members/'.Auth::user()->user_icon.'-s.jpg')); ?>" width="40" alt="person" class="img-circle">
...
</nav><?php /**PATH C:\xampp\htdocs\dekko\resources\views/admin/topbar.blade.php ENDPATH**/ ?>