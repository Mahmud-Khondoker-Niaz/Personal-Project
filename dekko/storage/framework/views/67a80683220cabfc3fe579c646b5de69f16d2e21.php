...
<div id="main">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('sku.store')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dekko\resources\views/admin/skus/sku-post.blade.php ENDPATH**/ ?>