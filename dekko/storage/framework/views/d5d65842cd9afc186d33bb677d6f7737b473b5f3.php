...
<?php $__env->startSection("content"); ?>
    ...
    <div class="inner-container container" style="margin-top: 50px;
      ...
      <div class="top-section clearfix">
              ...
              <a href="<?php echo e(route('blog.single',['id'=> $result->id])); ?>">   <img src="<?php echo e(URL::asset($result->feature)); ?>" class="lazyOwl" alt="<?php echo e($result->title); ?>" style="max-width: 100%; height: auto; border-top-left-radius: 80px 80px;"> 
</a>  
            </div>
                <!-- Description-->
                <div class="col-xs-12 col-md-6 col-sm-12"">
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dekko\resources\views/blogs/blogs.blade.php ENDPATH**/ ?>